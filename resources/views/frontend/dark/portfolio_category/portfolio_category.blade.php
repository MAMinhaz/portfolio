...
@section('portfolio_title')
    Portfolios Of "{{ $portfolio->PortfolioCats->category_name }}"
@endsection
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="section-title">
                        <h2 class="title-main">All Portfolio's Of "{{ $portfolio->PortfolioCats->category_name }}"</h2>
                ...
                <div class="col-md-6 col-lg-4 app item">
                    <div class="portfolio-item" data-animate="hg-fadeInUp">
                        ...
                        <div class="content">
                            ...
                            <div class="cate"><a href="{{ route('show_portfolios_category', $portfolio->category_id) }}">{{ $portfolio->PortfolioCats->category_name }}</a></div>
                        </div>
                    </div><!--  /.portfolio-item -->
                </div><!-- /.col-lg-4 -->
            </div><!--  /.row -->

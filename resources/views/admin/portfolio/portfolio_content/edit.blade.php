        ...
        <div class="col-md-12">
            <div class="card m-b-20 text-xs-center">
                <div class="card-block">
                    <h4 class="card-title">Edit Existing Portfolio Details</h4>
                    <form method="POST" action="{{ route('portfolio_edit_post') }}">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <input type="text" class="form-control" placeholder="Insert Portfolio Description Here" name="description" value="{{ $portfo_details->description }}">
                                        </div>

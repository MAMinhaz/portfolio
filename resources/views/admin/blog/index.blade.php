...
@section('admin_content')
                ...
                <div class="card m-b-20 card-block mt-3 mb-3">
                    <h4 class="card-title">Blog Post's Category</h4>
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @isset($blog_cat->created_at)
                                                    ...
                                                    <li>Duration : {{ $blog_cat->created_at->diffForHumans() }}</li>
                                                @endisset
                                            </td>
                                            <td>
                                                @isset($blog_cat->updated_at)
                                                    <li>Date : {{ $blog_cat->updated_at->format('d:m:Y') }}</li>
                                                    <li>Duration : {{ $blog_cat->updated_at->diffForHumans() }}</li>
                                                @endisset
                                            </td>
                                            <td>

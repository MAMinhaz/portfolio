...
@section('admin_content')
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">Portfolio - Contact Block</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Contact Block Content</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="card m-b-20 card-block mt-3 mb-3">
                    <h4 class="card-title">Recived Contacts</h4>
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <tbody>
                                    @foreach($contacts as $contact)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('contact_hard_delete', $contact->id) }}" class="btn btn-danger btn-rounded w-md waves-effect waves-light w-sm btn-sm">Delete Contact Info</a>

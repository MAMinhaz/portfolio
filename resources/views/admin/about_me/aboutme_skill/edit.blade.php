    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Edit Existing Skill</h4>
            </div>
        </div>
    </div>
                ...
                <div class="card-block">
                    <form method="POST" action="{{ route('aboutme_skill_edit_post') }}">
                        ...
                        <div class="form-group">
                            <label style="font-size: 130%">Skill Name</label>
                        ...
                        <div class="form-group">
                            <label style="font-size: 130%">Skill Percent</label>
                        ...
                        <br>
                    <a href="{{ route('aboutme') }}#about_me_skill" class="btn btn-purple btn-rounded w-md waves-effect waves-light">Return Back</a>
                </div>
            </div>
        </div>
    </div>
